<template>
  <div class="trailerManagement container mt-3">
    ...
    <div v-if="!found">
        <input v-model="searchTerm" class="form-control mr-sm-2 mb-1" type="text" placeholder="Search">
    ...
    <form v-if="found" > 
        <fieldset>
            ...
            <button type="button" @click="updateTrailer()" class="btn btn-primary mr-1">Edit Trailer</button>
