<template>
  <div class="container">
    ...
    <div>
      ...
      <h4>{{ dock }}</h4>
      <div v-for="trailer in trailers" v-if="trailer.trailerLocation == dock" v-on:click="test()" :key="trailer._id" :class="{'inner-seat': trailer.trailerLocation == dock, 'populated': trailer.trailerLocation == dock }">
